      ...
      <nav className="fixed w-full bg-white h-[90px] flex items-center z-10">
        <div className="w-[97%] mx-auto flex items-center justify-between">
          <div className='flex items-center gap-[80px]'>
            <Link href={"/"}>
              <img className="w-[90px]" src="/logos/logomain.svg" alt="Logo"></img>
            </Link>
            
            <div className='flex items-center gap-[14px] text-main font-[500]'>
          ...
          <div className='flex items-center gap-[20px] text-main'>
            <div className='flex items-center gap-[5px] text-[15px] font-[300]'>
              <Link href={"/dk"}>DK</Link>
              <p>|</p>
              <Link href={"/"}>EN</Link>
            </div>
            <Link className='bg-main text-white px-[20px] font-[300] text-[15px] py-[10px] rounded-full' href={"/proice"}>Pricecalculator</Link>
          </div>
      </div>
      </nav>
    </>
